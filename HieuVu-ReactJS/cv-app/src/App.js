    ...
    if (localData.length === 0) {
      this.setState({
        ...
        rightSection: [
          {
            name: 'Học vấn',
            value: 'Sinh viên năm 4 Đại Học Bách Khoa Hà Nội, CPA 2.5',
          },
          {
            name: 'Khả năng lập trình',
            value:
              'Nắm được cơ bản Javascript,Nodejs và cơ sở dữ liệu NoSql: MongoDB.',
          },
          { name: 'Sở Thích', value: 'Chơi game, kiếm tiền và tiêu tiền.' },
          {
            name: 'Mong muốn',
            value: 'Trở thành một fulstack web developer giàu có.',
          },
        ],
      });
    } else {
